...
# Crab giant pulses
crabgrp=np.loadtxt('/arc/projects/chime_frb/mseth/plots/data_from_nimmo/crab_giant.txt')
crabip=np.loadtxt('/arc/projects/chime_frb/mseth/plots/data_from_nimmo/crab_giant.ip.txt')
crabgrpx=[]
crabgrpy=[]
...
frb121102=np.loadtxt('/arc/projects/chime_frb/mseth/plots/data_from_nimmo/frb121102.txt')
frb121102x=[]
frb121102y=[]
...
frb180916=np.loadtxt('/arc/projects/chime_frb/mseth/plots/data_from_nimmo/frb180916.txt')
frb180916x=[]
frb180916y=[]
...
frb190711=np.loadtxt('/arc/projects/chime_frb/mseth/plots/data_from_nimmo/frb190711.txt')
frb190711x=[]
frb190711y=[]
...
# R3 Nimmo et al. 2021
frb180916_micro = np.loadtxt('/arc/projects/chime_frb/mseth/plots/data_from_nimmo/frb180916_micro.txt')
frb180916_microx=[]
frb180916_microy=[]
...
m81nano=np.loadtxt('/arc/projects/chime_frb/mseth/plots/data_from_nimmo/m81_nano.txt')
print(m81nano)
m81nanox = []
m81nanoy = []
